    ...
    >
        ...
        <div className="flex items-center justify-between h-16 lg:h-18">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden sm:inline-flex flex-col items-center gap-0 bg-gold text-navy-900 font-body font-bold text-sm px-5 py-2 rounded-full hover:bg-gold-light transition-colors duration-200 leading-tight"
              aria-label="Call now for a free quote at (614) 350-5978"
            >
              ...
              <span className="text-navy-900/70 text-xs font-medium">(614) 350-5978</span>
            </a>
      ...
      >
        <nav className="flex flex-col px-6 py-8 gap-2" aria-label="Mobile navigation">
          ...
          <a
            href="tel:+16143505978"
            className="mt-6 inline-flex flex-col items-center justify-center gap-0.5 bg-gold text-navy-900 font-body font-bold text-xl px-8 py-4 rounded-full hover:bg-gold-light transition-colors duration-200"
          >
            ...
            <span className="text-navy-900/70 text-sm font-medium">Free Quote · Same-Day Available</span>
          </a>
        </nav>
      </div>
    </header>
