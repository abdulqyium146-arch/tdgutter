const trustItems = [
  ...
  },
  {
    ...
    sublabel: 'No cost, no obligation',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    label: 'Veteran Proud',
    sublabel: 'Discounts for those who serve',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {trustItems.map((item) => (
            <div key={item.label} className="flex flex-col items-center text-center gap-3">
              ...
              <div>
                ...
                <p className="font-body text-slate text-xs mt-0.5">{item.sublabel}</p>
              </div>
            </div>
          ))}
        </div>
